...
class test_config:
    ...
    temperature: float = 0.8  # TODO: Needs some readings and experimentation -> The lower the temperature, the more empty results or at least very little confidence in output
